...
public class Llibre_Cientific extends Llibre {
	...
	public Llibre_Cientific(String titol, String[] autors, String tema, int num_edicio, String codi, int any_edicio,
			int dies_prestec, boolean actiu) {
		super(titol, autors, tema, num_edicio, any_edicio, codi, actiu);
		this.dies_prestec = dies_prestec;
	}

	/**
	 * Getters Retorna el nombre de dies maxim en el qual es pot tenir en prestec el
	 * llibre cientific
	 * 
	 * @return dies_prestec
	 */
	...
	public Llibre_Cientific Duplicat() {
		Llibre_Cientific aux = new Llibre_Cientific(this.titol, this.autors, this.tema, this.num_edicio,
				this.any_edicio, this.dies_prestec);
		return (aux);
	}
}
